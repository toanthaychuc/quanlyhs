        ...
        {modalStep === 'landing' && (
          <div className="welcome-slide-content">
            ...
            <h1 className="welcome-main-title">
              Kỷ luật mỗi ngày <br className="hidden md:block" />
              Làm chủ phòng thi
            </h1>

            {/* 3. Subtext */}
            <p className="welcome-subtext">
              Nền tảng rèn luyện kỷ luật và nâng cao kỹ năng giải toán.
            </p>
            ...
            <div className="welcome-actions-group">
              ...
              >
                <div className="google-icon-wrapper-small">
            ...
            {/* Subtle Link for Guest */}
            <div className="welcome-guest-link">
              <button onClick={handleGuestEntry}>
                Học thử không cần tài khoản <span>&rarr;</span>
              </button>
            </div>
          </div>
        )}
                ...
                <div className="form-group">
                  ...
                  <div style={{ position: 'relative' }}>
                    ...
                    <button 
                      type="button" 
                      className="btn-icon" 
                      style={{ position: 'absolute', right: '0.5rem', top: '50%', transform: 'translateY(-50%)', padding: '0.25rem', color: 'var(--text-secondary)' }}
